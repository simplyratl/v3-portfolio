...
shortDescription: Full-stack property management platform with admin panel and public website, featuring automated listing sync and advanced search capabilities, built using Next.js and AWS.
tag: Freelancing
